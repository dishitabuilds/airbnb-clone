// Auto-generated icon set. Every glyph is traced from the reference at the same
...
export function AirbnbLogo(props: IconProps) {
  return (
    <Svg viewBox="0 0 3490 1080" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Globe(props: IconProps) {
  return (
    <Svg viewBox="0 0 16 16" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Menu(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'none', stroke: 'currentColor', strokeWidth: 3, overflow: 'visible' }} {...props}>
...
export function Share(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'none', stroke: 'currentColor', strokeWidth: 2, overflow: 'visible' }} {...props}>
...
export function GuestFavourite(props: IconProps) {
  return (
    <Svg viewBox="0 0 20 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
      <path fillRule="evenodd" clipRule="evenodd" d="M15.4895 25.417L14.8276 24.4547L16.5303 23.6492L17.1923 24.6116L16.3409 25.0143L17.1923 24.6116C18.6638 26.751 17.9509 29.3868 15.5999 30.4989C14.8548 30.8513 14.0005 31.0196 13.1221 30.987L12.8044 30.9752L12.7297 29.2305L13.0474 29.2423C13.5744 29.2618 14.0871 29.1608 14.5341 28.9494C15.9447 28.2821 16.3725 26.7007 15.4895 25.417Z" fill="#222222" /><path fillRule="evenodd" clipRule="evenodd" d="M8.32441 10.235C10.0819 8.96204 10.9247 7.4878 10.853 5.81232C10.7813 4.13685 9.80929 2.59524 7.93708 1.18749C6.17964 2.46049 5.33678 3.93473 5.40851 5.6102C5.48024 7.28568 6.45221 8.82729 8.32441 10.235Z" fill="#F7F7F7" /><path fillRule="evenodd" clipRule="evenodd" d="M7.19425 0.489275C7.55718 0.226387 8.10753 0.246818 8.49416 0.537533C10.5385 2.07473 11.7071 3.84975 11.7923 5.84026C11.8775 7.83076 10.8574 9.52453 8.93841 10.9146C8.57548 11.1775 8.02513 11.157 7.6385 10.8663C5.59415 9.32914 4.4256 7.55411 4.34039 5.56361C4.25517 3.57311 5.27521 1.87933 7.19425 0.489275ZM7.92362 2.3684C6.77985 3.38355 6.29788 4.47199 6.3478 5.63813C6.39772 6.80428 6.97457 7.93203 8.20904 9.03547C9.35281 8.02032 9.83478 6.93187 9.78486 5.76573C9.73493 4.59959 9.15809 3.47184 7.92362 2.3684Z" fill="#222222" /><path fillRule="evenodd" clipRule="evenodd" d="M15.6806 24.0529C14.1314 22.353 12.4326 21.4688 10.5842 21.4001C8.73575 21.3315 7.10737 22.0923 5.69905 23.6824C7.24822 25.3823 8.94702 26.2666 10.7955 26.3352C12.6439 26.4038 14.2723 25.6431 15.6806 24.0529Z" fill="#F7F7F7" /><path fillRule="evenodd" clipRule="evenodd" d="M4.90529 24.1787C4.60807 23.8526 4.58911 23.4097 4.8593 23.1046C6.38985 21.3765 8.27538 20.4331 10.521 20.5164C12.7666 20.5998 14.7391 21.6864 16.4227 23.5339C16.7199 23.86 16.7389 24.303 16.4687 24.608C14.9381 26.3361 13.0526 27.2795 10.807 27.1962C8.56134 27.1128 6.5889 26.0262 4.90529 24.1787ZM6.98781 23.7198C8.22307 24.8808 9.46778 25.4045 10.7323 25.4515C11.9968 25.4984 13.2005 25.0656 14.3402 23.9928C13.1049 22.8318 11.8602 22.3081 10.5957 22.2611C9.3312 22.2142 8.12744 22.6471 6.98781 23.7198Z" fill="#222222" /><path fillRule="evenodd" clipRule="evenodd" d="M10.6766 20.7043C10.2137 18.5957 9.16392 17.0928 7.52727 16.1956C5.89062 15.2984 3.99442 15.1864 1.83867 15.8596C2.30157 17.9683 3.35135 19.4712 4.988 20.3684C6.62465 21.2656 8.52085 21.3775 10.6766 20.7043Z" fill="#F7F7F7" /><path fillRule="evenodd" clipRule="evenodd" d="M0.791956 15.9443C0.703053 15.5393 0.94431 15.1569 1.37329 15.023C3.7337 14.2859 5.9714 14.3695 7.95247 15.4554C9.92449 16.5364 11.1013 18.3139 11.6022 20.5956C11.6911 21.0006 11.4499 21.3829 11.0209 21.5169C8.66048 22.254 6.42277 22.1704 4.4417 21.0844C2.46969 20.0034 1.29285 18.226 0.791956 15.9443ZM2.95349 16.4656C3.43375 17.9951 4.27991 19.007 5.41321 19.6282C6.5306 20.2407 7.84423 20.4286 9.44069 20.0743C8.96043 18.5448 8.11427 17.5329 6.98097 16.9116C5.86358 16.2991 4.54995 16.1113 2.95349 16.4656Z" fill="#222222" /><path fillRule="evenodd" clipRule="evenodd" d="M7.90911 15.6267C8.65652 13.6743 8.53705 11.9555 7.55072 10.4702C6.56438 8.98484 4.90844 8.03014 2.58291 7.60605C1.8355 9.55846 1.95497 11.2773 2.9413 12.7626C3.92764 14.2479 5.58357 15.2026 7.90911 15.6267Z" fill="#F7F7F7" /><path fillRule="evenodd" clipRule="evenodd" d="M1.66037 7.28295C1.80927 6.89397 2.26578 6.67525 2.74598 6.76282C5.29848 7.22831 7.26368 8.31371 8.44396 10.0911C9.61955 11.8614 9.70866 13.854 8.89805 15.9715C8.74915 16.3605 8.29264 16.5792 7.81244 16.4916C5.25994 16.0261 3.29474 14.9407 2.11446 13.1634C0.938866 11.393 0.849755 9.40048 1.66037 7.28295ZM3.3385 8.6613C2.94038 10.1267 3.14588 11.3465 3.83454 12.3835C4.51397 13.4067 5.60091 14.1584 7.21992 14.5931C7.61804 13.1278 7.41254 11.9079 6.72388 10.8709C6.04445 9.84774 4.95751 9.09607 3.3385 8.6613Z" fill="#222222" />
    </Svg>
  );
}

export function StarSmall(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function OutdoorEntertainment(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function StayingCool(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function SelfCheckIn(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function ChevronRightTiny(props: IconProps) {
  return (
    <Svg viewBox="0 0 18 18" style={{ display: 'block', fill: 'currentColor' }} {...props}>
      <path d="m4.29 1.71a1 1 0 1 1 1.42-1.41l8 8a1 1 0 0 1 0 1.41l-8 8a1 1 0 1 1 -1.42-1.41l7.29-7.29z" fillRule="evenodd" />
    </Svg>
  );
}

export function Kitchen(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Workspace(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function HotTub(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Pets(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function SecurityCamera(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function CarbonMonoxideAlarm(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function SmokeAlarm(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function ChevronLeftSmall(props: IconProps) {
  return (
    <Svg viewBox="0 0 18 18" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function ClearDates(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 22" style={{ display: 'block', fill: 'currentColor' }} {...props}>
      <rect x="1" y="1" width="30" height="20" rx="3" /><path d="M6 7h.01M11 7h.01M16 7h.01M21 7h.01M26 7h.01M6 12h.01M26 12h.01M9 16h14" />
    </Svg>
  );
}
...
export function Cleanliness(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Accuracy(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function CheckInRating(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Communication(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'none', stroke: 'currentColor', strokeWidth: 2, overflow: 'visible' }} {...props}>
...
export function LocationRating(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Value(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Search(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'none', stroke: 'currentColor', strokeWidth: 2, overflow: 'visible' }} {...props}>
      <circle cx="14" cy="14" r="9" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><path d="M21 21l7 7" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
...
export function BornIn(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function MessageHost(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Back(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'none', stroke: 'currentColor', strokeWidth: 2, overflow: 'visible' }} {...props}>
      <path d="M20 28 8.7 16.7a1 1 0 0 1 0-1.4L20 4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
...
export function ArrowLeft(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'none', stroke: 'currentColor', strokeWidth: 4, overflow: 'visible' }} {...props}>
...
export function Hairdryer(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function CleaningProducts(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Shampoo(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function HotWater(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function ShowerGel(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Hangers(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
      <path d="M16 2a5 5 0 0 1 1.66 9.72 1 1 0 0 0-.65.81l-.01.13v.81l13.23 9.05a3 3 0 0 1 1.3 2.28v.2a3 3 0 0 1-3 3H3.47a3 3 0 0 1-1.69-5.48L15 13.47v-.81a3 3 0 0 1 1.82-2.76l.17-.07a3 3 0 1 0-3.99-3V7h-2a5 5 0 0 1 5-5zm0 13.21L2.9 24.17A1 1 0 0 0 3.46 26h25.07a1 1 0 0 0 .57-1.82z" />
    </Svg>
  );
}

export function BedLinen(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Iron(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function ClothesStorage(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Cot(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function AirConditioning(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Crockery(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
      <path d="M29 1v2a13 13 0 0 0-.3 26h.3v2a15 15 0 0 1-.31-30zM3 1h2v6h2V1h2v6h2V1h2v9a5 5 0 0 1-4 4.9V31H7V14.9a5.01 5.01 0 0 1-3.98-4.44L3 10.22V10zm26 6v2a7 7 0 0 0-.24 14H29v2a9 9 0 0 1-.27-18zM11 9H5v1.15a3 3 0 0 0 6 .03V10z" />
    </Svg>
  );
}

export function Kettle(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
      <path d="M26 28v2H6v-2h20zM16 1a8.64 8.64 0 0 1 7.83 5H28a1 1 0 0 1 1 1.08c-.3 3.87-1.58 6.45-3.9 7.56l.9 10.27a1 1 0 0 1-.88 1.08L25 26H7a1 1 0 0 1-1-.97v-.12L7.4 8.9c.02-.3.06-.6.12-.89H5a1 1 0 0 0-1 .88V19H2V9a3 3 0 0 1 2.82-3h3.35A8.64 8.64 0 0 1 16 1zm6.43 7H9.57a6.65 6.65 0 0 0-.14.7l-.04.36L8.1 24h15.82L22.6 9.06A6.67 6.67 0 0 0 22.43 8zm-5.45 3a9.82 9.82 0 0 1-2.7 5.78l-.23.24A6.96 6.96 0 0 0 12.07 21h-2.02a8.96 8.96 0 0 1 2.36-5.16l.23-.23A7.99 7.99 0 0 0 14.97 11h2.01zm4 0 .02.5a9.6 9.6 0 0 1-2.72 6.28l-.23.24A6.97 6.97 0 0 0 16.28 21h-2.06a8.96 8.96 0 0 1 2.19-4.16l.22-.23C18.09 15.16 19 13.2 19 11.5a4.94 4.94 0 0 0-.03-.5h2.01zm5.9-3h-2.4l.1.63.02.26.3 3.51c.99-.79 1.64-2.16 1.96-4.17l.03-.23zM16 3a6.63 6.63 0 0 0-5.55 3h11.1a6.63 6.63 0 0 0-5.04-2.98L16.23 3H16z" />
    </Svg>
  );
}
...
export function WineGlasses(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Toaster(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Blender(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
      <path d="M23 1a1 1 0 0 1 1 .88V6l-.02.2-2.9 14.53a5 5 0 0 1 2.31 3.4l.04.25.56 4.5a1 1 0 0 1-.87 1.11L23 30H9a1 1 0 0 1-1-1v-.12l.57-4.5a5 5 0 0 1 2.36-3.65L8.18 7H7a1 1 0 0 0-1 .88V15H4V8a3 3 0 0 1 2.82-3H8V2a1 1 0 0 1 .88-1H23zm-9.5 21a3 3 0 0 0-2.92 2.45l-.03.18-.42 3.37h11.74l-.42-3.37a3 3 0 0 0-2.62-2.6L18.5 22h-5zm2.5 2a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm5.78-17H10.22l2.6 13H15v-9h2v9h2.18l2.6-13zM22 3H10v2h12V3z" />
    </Svg>
  );
}

export function Cooker(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function PrivateEntrance(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function Patio(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function OutdoorDining(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
export function LongTermStays(props: IconProps) {
  return (
    <Svg viewBox="0 0 32 32" style={{ display: 'block', fill: 'currentColor' }} {...props}>
...
const AMENITY_ICONS: Record<string, (p: IconProps) => React.JSX.Element> = {
  "Kitchen": Kitchen,
  "Wifi": Wifi,
  ...
  "Hot tub": HotTub,
  "Pets allowed": Pets,
  "Exterior security cameras on property": SecurityCamera,
  ...
  "Iron": Iron,
  "Clothes storage": ClothesStorage,
  "Cot": Cot,
  "TV": TV,
  ...
  "Gym": Gym,
  "Long-term stays allowed": LongTermStays,
  "Self check-in": SelfCheckIn,
  "Cleaning available during stay": CleaningProducts,
  "Exercise equipment": Gym,
  "Ceiling fan": AirConditioning,
  "Sofa": OutdoorEntertainment,
  "Double bed": BedLinen,
};
